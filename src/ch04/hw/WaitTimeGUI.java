...
public class WaitTimeGUI
{
  ...
  private static JLabel idleLabel;
  ...
  private static class ActionHandler implements ActionListener 
  {
    ...
    // listener for the button events
    {
      ...
      { // Handles Evaluate event.
        float result;
        AverageWaitTimes sim = new AverageWaitTimes
  ...
  public static void main(String args[]) throws IOException
  {
    ...
    displayFrame.setTitle("Queue AverageWaitTimes Program");
    ...
    idleLabel    = new JLabel("   IDLE  ", JLabel.CENTER);
    ...
    idlePanel.setLayout(new FlowLayout(FlowLayout.LEFT));
    ...
    contentPane.add(idlePanel,"South");
