...
//Problem #1 part 3, count swaps
//Problem #10, 24 count the compares
...
public class Sorts
{
  ...
  static int[] originalArray = new int[SIZE];
  static int[] compareArray, swapArray;
  ...
  {
	compareArray = new int[sortTypes.maxSort.sortValue];
	Arrays.fill(compareArray, 0);
	swapArray = new int[sortTypes.maxSort.sortValue];
	Arrays.fill(swapArray, 0);
    ...
    for (int index = 0; index < SIZE; index++)
    {
      ...
      originalArray[index] = values[index];
    }
  }
  ...
  // Restore unsorted array
  {
    for (int index = 0; index < SIZE; index++)
    {
      values[index] = originalArray[index];
    }
  }
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("\nSelection sort");
    //printValues();
    currentSort = sortTypes.selectionSort.sortValue;
    selectionSort();
    System.out.println("Swaps = " + swapArray[currentSort]);
    System.out.println("Compares = " + compareArray[currentSort]);
    //printValues();
    ...
    System.out.println("\nBubble sort");
    //printValues();
    currentSort = sortTypes.bubbleSort.sortValue;
    bubbleSort();
    System.out.println("Swaps = " + swapArray[currentSort]);
    System.out.println("Compares = " + compareArray[currentSort]);
    //printValues();
    ...
    System.out.println("\nShort Bubble sort");
    //printValues();
    currentSort = sortTypes.shortBubble.sortValue;
    shortBubble();
    System.out.println("Swaps = " + swapArray[currentSort]);
    System.out.println("Compares = " + compareArray[currentSort]);
    //printValues();
    ...
    System.out.println("\nInsertion sort");
    //printValues();
    currentSort = sortTypes.insertionSort.sortValue;
    insertionSort();
    System.out.println("Swaps = " + swapArray[currentSort]);
    System.out.println("Compares = " + compareArray[currentSort]);
    //printValues();
    ...
    System.out.println("\nMerge sort");
    //printValues();
    currentSort = sortTypes.mergeSort.sortValue;
    mergeSort(0, SIZE - 1);
    System.out.println("Swaps = " + swapArray[currentSort]);
    System.out.println("Compares = " + compareArray[currentSort]);
    //printValues();
    ...
    System.out.println("\nQuick sort");
    //printValues();
    currentSort = sortTypes.quickSort.sortValue;
    quickSort(0, SIZE - 1);
    System.out.println("Swaps = " + swapArray[currentSort]);
    System.out.println("Compares = " + compareArray[currentSort]);
    //printValues();
    ...
    System.out.println("\nHeap sort");
    //printValues();
    currentSort = sortTypes.heapSort.sortValue;
    heapSort();
    System.out.println("Swaps = " + swapArray[currentSort]);
    System.out.println("Compares = " + compareArray[currentSort]);
    //printValues();
